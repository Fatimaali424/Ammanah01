...
export default function Contact() {
    return (
        <div>
            <div 
                className="flex flex-col items-center justify-center min-h-screen p-2 font-serif relative"
                style={{
            ...
            >
                ...
                <div className="relative z-10 bg-white bg-opacity-80 shadow-lg rounded-2xl p-8 max-w-lg w-full text-center">
